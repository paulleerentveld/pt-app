...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post workouts_url, params: { workout: { status: @workout.status, type: @workout.type } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { status: @workout.status, type: @workout.type } }
